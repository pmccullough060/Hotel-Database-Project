...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 28, 2021 at 06:14 PM
...
--
ALTER TABLE `hotelimage`
  MODIFY `hotelimage_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `roomimage`
  MODIFY `roomimage_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
