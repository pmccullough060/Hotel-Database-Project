...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2021 at 09:48 PM
...
INSERT INTO `bed` (`bed_id`, `type`) VALUES
(1, 'single'),
(2, 'queen double'),
(3, 'king double'),
(4, 'sofa bed');
...
CREATE TABLE `roomimage` (
  ...
  `room_id` int(11) NOT NULL,
  `imageguid` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `cancellationpolicy`
  MODIFY `cancellationpolicy_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `roomimage`
  MODIFY `roomimage_id` int(11) NOT NULL AUTO_INCREMENT;
